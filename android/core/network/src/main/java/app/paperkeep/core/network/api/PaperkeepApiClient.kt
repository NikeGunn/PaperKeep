package app.paperkeep.core.network.api

import app.paperkeep.core.network.auth.TokenStore
import app.paperkeep.core.network.model.ApiError
import app.paperkeep.core.network.model.ChangePasswordRequest
import app.paperkeep.core.network.model.ConfirmUploadRequest
import app.paperkeep.core.network.model.DownloadUrlResponse
import app.paperkeep.core.network.model.SyncManifestItem
import app.paperkeep.core.network.model.UploadUrlRequest
import app.paperkeep.core.network.model.UploadUrlResponse
...
/**
 * Typed Ktor client for all Paperkeep API calls.
 * Token injection is handled by the HttpClient's auth plugin (in NetworkModule).
 */
@Singleton
class PaperkeepApiClient @Inject constructor(
