package app.paperkeep.core.network.di

import android.content.Context
import app.paperkeep.core.network.BuildConfig
import app.paperkeep.core.network.auth.TokenStore
import app.paperkeep.core.network.ota.OtaConfigManager
                ...
                install(Logging) {
                    logger = object : Logger {
                        override fun log(message: String) {
                            android.util.Log.d("PaperkeepHttp", message)
                        }
                    }
                    level = LogLevel.INFO
                }
