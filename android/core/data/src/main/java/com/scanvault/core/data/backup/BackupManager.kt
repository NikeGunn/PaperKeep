...
private const val BACKUP_PREFIX = "ScanVault_Backup_"
...
class BackupManager @Inject constructor(
    ...
    private val imageStore: AesGcmImageStore,
) {
                ...
                ZipOutputStream(cos).use { zos ->
                    ...
                    documents.forEachIndexed { docIdx, docWithPages ->
                        docWithPages.pages.forEachIndexed { pageIdx, page ->
                            try {
                                val imageBytes = imageStore.readDecrypted(page.imagePath)
                            ...
                            entry.name.startsWith("pages/") -> {
                                ...
                                if (imageBytes.isNotEmpty()) {
                                    ...
                                    if (bitmap != null) {
                                        ...
                                        imageStore.writeEncrypted(destPath, imageBytes)
                                        pageCount++
                                    }
                                }
                            }
