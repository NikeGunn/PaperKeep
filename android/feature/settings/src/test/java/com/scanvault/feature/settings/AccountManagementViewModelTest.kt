...
import com.scanvault.core.crypto.VaultCrypto
...
class AccountManagementViewModelTest {
    ...
    private lateinit var apiClient: ScanVaultApiClient
    ...
    fun changePassword_rewrapsVaultKey() = runTest {
        ...
        coEvery { apiClient.changePassword(any()) } answers {
            requestedWrappedKey = firstArg<com.scanvault.core.network.model.ChangePasswordRequest>().wrappedKey
            Result.success(Unit)
        }
